...
<div class="container mt-3"> 
    ...
    <div class="col-10">
    <input class="form-control form-control-lg" name="codigo" autofocus id="codigo" type="text" placeholder="Código de barras del producto" aria-label="codigoBarras" list="opcionesCodigo">
</div>

<datalist id="opcionesCodigo">
    <option value="123456789"></option>
    <option value="987654321"></option>
    <option value="567890123"></option>
    <option value="111222333"></option>
    <option value="444555666"></option>
